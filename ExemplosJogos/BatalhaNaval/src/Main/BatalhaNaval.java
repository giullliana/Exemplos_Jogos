    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            if (acaoDoJogador()) {
                ...
                int numeroGerado = jogadaDoComputador.nextInt(tamanhoX);
                posicoes[POSICAO_X] = (numeroGerado == tamanhoX) ? --numeroGerado : numeroGerado;
                numeroGerado = jogadaDoComputador.nextInt(tamanhoY);
                posicoes[POSICAO_Y] = (numeroGerado == tamanhoY) ? --numeroGerado : numeroGerado;
